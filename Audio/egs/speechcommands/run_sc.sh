...
exp_dir=./exp/test-${dataset}-f$fstride-t$tstride-p$imagenetpretrain-b$batch_size-lr${lr}-RepLKv2_Audio
...
CUDA_VISIBLE_DEVICES=5 python -W ignore ../../src/run.py --model ${model} --dataset ${dataset} \
